...
var pics=document.getElementsByClassName('b-lazy');for(var i=0;i<pics.length;i++){pics[i].setAttribute('src','data:image/gif;base64,R0lGODlhAQABAIAAAAUEBAAAACwAAAAAAQABAAACAkQBADs=')}
/*!
